...
import com.yanxi.filemove.utils.FileMoveUtils;
import com.yanxi.filemove.utils.ZipUtils;
...
public class MyFrame extends JFrame implements ActionListener {
	...
	private void initButton() {
		...
		submit_content = new JButton("1-文件移动");
		submit_content.setFont(font);
		zip_content = new JButton("2-文件压缩");
